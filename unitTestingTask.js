(function (root, factory) {
    ...
    var tokens = {
        ...
        MMMM: function (date, format) {
            return languages[unitTestingTask.lang()].months(date, format);
        },
        MMM: function (date, format) {
            return languages[unitTestingTask.lang()].monthsShort(date, format);
        },
        MM: function (date) {
     ...
     * @return {Array}
     */
    unitTestingTask.formatters = function () {
        return Object.keys(unitTestingTask._formatters);
    };
    ...
    /**
     * Cleans global namespace, restoring previous value of window.unitTestingTask, and returns unitTestingTask itself.
     *
